        ...
        <>
            <section className="max-w-screen h-150">
                <div className="relative w-full h-full">
                    <img className="w-full h-full object-cover brightness-45" src={imgBanner} alt="Image Banner"/>
                    <div className="w-full h-auto flex flex-col justify-center items-center p-4 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                        <div className="flex flex-col justify-center items-center space-y-4 text-white text-center">
                            ...
                            <h2 className="text-4xl font-light font-cinzel">
                                Pahrump Realtor
                            </h2>
                            <a className="w-full h-10 flex justify-center items-center bg-white rounded-full font-montserrat text-black" href="tel: (206) 919-6886">
                            ...
                            <div className="w-full grid grid-cols-2 justify-center items-center font-cinzel text-center">
                                <div className="stat p-0">
                                    <h2 className="stat-title text-white text-lg">CLIENTS</h2>
                                    <h3 className="stat-value">90+</h3>
                                    <h4 className="stat-desc text-white text-lg">IN 2021</h4>
                                </div>
                                <div className="stat p-0">
                                    <h2 className="stat-title text-white text-lg">SALES</h2>
                                    <h3 className="stat-value">$28.5M</h3>
                                    <h4 className="stat-desc text-white text-lg">IN TOTAL</h4>
                                </div>
                            </div>
            ...
            <section className="max-w-screen">
                <div className="w-full h-full flex flex-col justify-center items-center space-y-4 px-4 py-6 bg-white text-black font-montserrat">
                    <div className="size-70 rounded-full overflow-hidden">
                        <img src={imgProfile} alt="Marci Metzger – Realtor" />
                    </div>
                    <div className="flex flex-col justify-center items-center space-y-3">
                        ...
                        <p className="text-base font-normal text-center">
                            I’m Marci Metzger, a real estate broker with over 30 years of experience. In 2021, me and my team helped 90 clients close deals totaling $28.5 million. My focus is on providing expert guidance and making the real estate process seamless for every client. Whether buying or selling, I’m dedicated to delivering successful outcomes with personalized service.
                        </p>
                    </div>
                </div>
            </section>
